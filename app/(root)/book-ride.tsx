...
const BookRide = () => {
    ...
    return (
        <StripeProvider
            ...
            merchantIdentifier="merchant.goalong.com" // required for Apple Pay
        ...
        <RideLayout title="Book Ride">
            <>
                ...
                <View
                    className="flex flex-col w-full items-start justify-center py-3 px-5 rounded-3xl bg-general-600 mt-2">
